...
export function VerifyEmailPage(){
 ...
 async function send(){if(!firebaseUser)return;setLoading(true);setMsg('');try{auth.languageCode='pt-BR';await sendEmailVerification(firebaseUser);setMsg('E-mail de confirmação enviado em português. Verifique sua caixa Spam.');}catch{setMsg('Não foi possível enviar agora. Aguarde um pouco e tente novamente.');}finally{setLoading(false)}}
