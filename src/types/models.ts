...
export interface Store {
  ...
  checkoutMode?:CheckoutMode; allowPix?:boolean; allowCard?:boolean; allowCash?:boolean; allowPickup?:boolean; allowDelivery?:boolean; deliveryFee?:number; deliveryFeeMode?:'zones'|'default'; lowStockThreshold?:number; paymentProviderConnected?:boolean; mercadoPagoPublicKey?:string; bannerText?:string; businessHours?:string; showStock?:boolean; minOrderValue?:number; preparationTime?:string; orderPrefix?:string; returnPolicy?:string; supportPhone?:string; monthlySalesGoal?:number;
}
...
export interface Order {
  id:string; storeId:string; customerName:string; customerPhone:string; customerEmail?:string; fulfillment:FulfillmentType; address?:string; paymentMethod:string; source?:string; items:OrderItem[]; subtotal:number; discount?:number; couponCode?:string; deliveryFee:number; deliveryZoneId?:string; deliveryZoneName?:string; total:number; status:OrderStatus; paymentStatus:PaymentStatus; mercadoPagoOrderId?:string; mercadoPagoPaymentId?:string; pix?:{qrCode?:string;qrCodeBase64?:string;ticketUrl?:string}; customerNotes?:string; merchantNotes?:string; createdAt?:any;
}
